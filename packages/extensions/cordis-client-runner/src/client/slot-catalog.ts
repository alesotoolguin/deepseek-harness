...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.hero.workspace.utilities',
    kind: 'list',
    scope: 'session-maybe',
    summary: 'Trailing status controls in the hero workspace row, silent without a current Session.',
    doc: 'Trailing status controls in the hero workspace row, silent without a current Session.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.workspace.utilities\', () => ctx.slots.register(\n      { name: \'conversation.hero.workspace.utilities\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
