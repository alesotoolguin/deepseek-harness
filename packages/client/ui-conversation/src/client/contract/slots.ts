...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Trailing status controls in the hero workspace row, silent without a current Session. */
    'conversation.hero.workspace.utilities': { kind: 'list'; scope: 'session-maybe'; owner: HeroWorkspaceUtilitiesOwnerProps }
